...
func easyjsonF642ad3eDecodeGithubComTrb1makerOtusGolangHomeWorkHw12131415CalendarInternalStorage(in *jlexer.Lexer, out *Event) {
...
func easyjsonF642ad3eEncodeGithubComTrb1makerOtusGolangHomeWorkHw12131415CalendarInternalStorage(out *jwriter.Writer, in Event) {
	out.RawByte('{')
	first := true
	_ = first
	if in.ID != "" {
